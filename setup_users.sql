...
('demo-admin-001', 'admin@loyaltypro.com', '$2y$13$r2ycEYr7ZGcV/3DcC8lbvOezuiG5safNgjuv16TjrTtO8KHdoWJkm', '', true, NOW(), 'admin@loyaltypro.com', 'admin', 'System', 'Administrator')
...
INSERT INTO ol__user (id, username, password, salt, is_active, create_at, email, dtype, first_name, last_name) VALUES 
('demo-seller-001', 'seller@loyaltypro.com', '$2y$13$r2ycEYr7ZGcV/3DcC8lbvOezuiG5safNgjuv16TjrTtO8KHdoWJkm', '', true, NOW(), 'seller@loyaltypro.com', 'seller', 'Coffee', 'Shop Manager')
ON CONFLICT (username) DO NOTHING;
...
INSERT INTO ol__user (id, username, password, salt, is_active, create_at, email, dtype, first_name, last_name) VALUES 
('demo-customer-001', 'customer@loyaltypro.com', '$2y$13$r2ycEYr7ZGcV/3DcC8lbvOezuiG5safNgjuv16TjrTtO8KHdoWJkm', '', true, NOW(), 'customer@loyaltypro.com', 'customer', 'John', 'Doe')
ON CONFLICT (username) DO NOTHING;
...
INSERT INTO ol__user (id, username, password, salt, is_active, create_at, email, dtype, first_name, last_name) VALUES 
('demo-seller-002', 'restaurant@loyaltypro.com', '$2y$13$r2ycEYr7ZGcV/3DcC8lbvOezuiG5safNgjuv16TjrTtO8KHdoWJkm', '', true, NOW(), 'restaurant@loyaltypro.com', 'seller', 'Restaurant', 'Manager'),
('demo-seller-003', 'retail@loyaltypro.com', '$2y$13$r2ycEYr7ZGcV/3DcC8lbvOezuiG5safNgjuv16TjrTtO8KHdoWJkm', '', true, NOW(), 'retail@loyaltypro.com', 'seller', 'Retail', 'Store')
ON CONFLICT (username) DO NOTHING;
...
SELECT '  - admin@loyaltypro.com / admin123' as credentials;
SELECT 'Seller users:' as user_type;
SELECT '  - seller@loyaltypro.com / seller123' as credentials;
SELECT '  - restaurant@loyaltypro.com / admin123' as credentials;
SELECT '  - retail@loyaltypro.com / admin123' as credentials;
SELECT 'Customer users:' as user_type;
SELECT '  - customer@loyaltypro.com / customer123' as credentials;
