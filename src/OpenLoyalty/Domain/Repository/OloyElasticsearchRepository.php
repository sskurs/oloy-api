 ...
 */
class OloyElasticsearchRepository implements RepositoryInterface
{
    protected $client;
    ...
    {
        $data = $this->serializer->serialize($readModel);
        $id = $readModel->getId();
    ...
    public function find($id)
    {
        try {
            ...
            return $this->serializer->deserialize($response['_source']);
    ...
    public function findBy(array $fields)
    {
        ...
        return $this->deserializeHits($response['hits']['hits']);
    }
